...
@Table
@Entity(name = "blood_pressure_heartbeat")
public class BloodPressureHeartBeat implements Measurement{
	...
	public TO<BloodPressureHeartBeat> convertToTO(TO<BloodPressureHeartBeat> to){
