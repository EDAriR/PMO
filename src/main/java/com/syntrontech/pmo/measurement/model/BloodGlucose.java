...
import com.syntrontech.pmo.measurement.model.common.GlucoseType;
...
public class BloodGlucose implements Measurement{
	...
	public GlucoseType getGlucoseType() {
		return glucoseType;
	}
	...
	public TO<BloodGlucose> convertToTO(TO<BloodGlucose> to){
