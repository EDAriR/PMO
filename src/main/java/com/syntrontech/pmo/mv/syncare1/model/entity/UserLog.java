...
import com.syntrontech.syncare.model.common.UserLogType;
import com.syntrontech.syncare.model.transfer.LogTO;
...
public class UserLog implements ObjectConverter<LogTO>, Serializable {
	...
	@Override
	public LogTO convert(boolean relation) {
		LogTO to = new LogTO();
		to.setId(getId());
		to.setLogInfo(getLogInfo().getLabel());
		to.setLogType(getLogType().getLabel());
		to.setLogDateTime(new Date());
		to.setLogMemo(getLogMemo());
