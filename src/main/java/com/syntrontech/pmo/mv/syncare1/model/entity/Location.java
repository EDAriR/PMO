...
import com.syntrontech.syncare.model.transfer.LocationTO;
...
public class Location implements ObjectConverter<LocationTO>, Serializable {
	...
	@Override
	public LocationTO convert(boolean relation) {
		LocationTO to = new LocationTO();
		to.setId(getId());
		to.setName(getName());
		to.setCity(getCity());
		to.setAddress(getAddress());
		to.setContact(getContact());
		to.setPhone(getPhone());
		return to;
	}
