...
import com.syntrontech.syncare.model.transfer.SimpleAbnormalViewTO;

@Entity
@Table(name = "SIMPLE_ABNORMAL_VIEW")
@NamedQuery(name = "SimpleAbnormalView.findAll", query = "SELECT s FROM SimpleAbnormalView s")
public class SimpleAbnormalView implements ObjectConverter<SimpleAbnormalViewTO>, Serializable {
	...
	@Override
	public SimpleAbnormalViewTO convert(boolean relation) {
