...
import com.syntrontech.syncare.model.transfer.HealthInfoTO;
...
public class HealthInfo implements ObjectConverter<HealthInfoTO>, Serializable {
	...
	@Override
	public HealthInfoTO convert(boolean relation) {
		HealthInfoTO to = new HealthInfoTO();
		to.setId(getId());
