...
import com.syntrontech.syncare.model.transfer.BloodPressureRecordReportTO;
...
public class BloodPressureRecordReport implements ObjectConverter<BloodPressureRecordReportTO>, Serializable {
	...
	@Override
	public BloodPressureRecordReportTO convert(boolean relation) {
		BloodPressureRecordReportTO bloodPressureRecordReportTO = new BloodPressureRecordReportTO();
		bloodPressureRecordReportTO.setAccount(account);
		bloodPressureRecordReportTO.setWithHighBloodPressure(withHighBloodPressure);
		if (null != recordDate)
			bloodPressureRecordReportTO.setRecordDate(SDF_DISPLAY.format(recordDate));
		if (null != uploadDate)
			bloodPressureRecordReportTO.setRecordDate(SDF_DISPLAY.format(uploadDate));
		bloodPressureRecordReportTO.setCaseStatusDisplay(caseStatusDisplay);
		bloodPressureRecordReportTO.setMaxBlood(maxBlood);
		bloodPressureRecordReportTO.setMinBlood(minBlood);
		bloodPressureRecordReportTO.setCity(city);
		bloodPressureRecordReportTO.setToken(token);
		bloodPressureRecordReportTO.setSex(sex);
		bloodPressureRecordReportTO.setRecluse(recluse);
		bloodPressureRecordReportTO.setAge(age);
		return bloodPressureRecordReportTO;
	}
